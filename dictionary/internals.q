...
.kdb.dict.bang: (!) . flip raze 2 cut
    (
        ...
        (`$"-14!"; .kdb.desc.func.minus14Bang);
        (`$"-15!"; .kdb.desc.func.minus15Bang);
        (`$"-16!"; .kdb.desc.func.minus16Bang);
        (`$"-18!"; .kdb.desc.func.minus18Bang);
        (`$"-21!"; .kdb.desc.func.minus21Bang);
        (`$"-22!"; .kdb.desc.func.minus22Bang);
        (`$"-23!"; .kdb.desc.func.minus23Bang);
        (`$"-25!"; .kdb.desc.func.minus25Bang);
        (`$"-26!"; .kdb.desc.func.minus26Bang);
        (`$"-27!"; .kdb.desc.func.minus27Bang);
        (`$"-30!"; .kdb.desc.func.minus30Bang);
