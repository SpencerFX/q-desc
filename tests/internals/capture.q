/ ==================================================
/ internals example capture functions
/ ==================================================

/ --------------------------------------------------
/ map q type code to readable label
/ --------------------------------------------------
.test.intl.typeLabel:{[typeCode]
  code:`int$typeCode;
  $[code=-19;"timeAtom";
    code=-18;"secondAtom";
    code=-17;"minuteAtom";
...
/ --------------------------------------------------
.test.intl.exists:{[fnSym]
  fnVal:.test.intl.resolve fnSym;
  not fnVal~(::)
 };
...
/ --------------------------------------------------
.test.intl.capture:{[label;fnSym]
  fnExists:.test.intl.exists fnSym;
  fnVal:.test.intl.resolve fnSym;
  ...
  resultTypeName:$[ok;.test.intl.typeLabel resultTypeCode;""];
  resultPreview:$[ok;.test.intl.preview resultVal;""];
