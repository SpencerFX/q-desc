/ ==================================================
/ namespaceZ example capture functions
/ ==================================================

/ --------------------------------------------------
/ map q type code to readable label
/ --------------------------------------------------
.test.nsz.typeLabel:{[typeCode]
  code:`int$typeCode;
  $[code=-19;"timeAtom";
    code=-18;"secondAtom";
    code=-17;"minuteAtom";
...
/ --------------------------------------------------
.test.nsz.exists:{[fnSym]
  fnVal:.test.nsz.resolve fnSym;
  not fnVal~(::)
 };
...
/ --------------------------------------------------
.test.nsz.capture:{[label;fnSym]
  fnExists:.test.nsz.exists fnSym;
  fnVal:.test.nsz.resolve fnSym;
  ...
  resultTypeName:$[ok;.test.nsz.typeLabel resultTypeCode;""];
  resultPreview:$[ok;.test.nsz.preview resultVal;""];
