/ ==================================================
/ namespaceJ example capture functions
/ ==================================================

/ --------------------------------------------------
/ map q type code to readable label
/ --------------------------------------------------
.test.nsj.typeLabel:{[typeCode]
  code:`int$typeCode;
  $[code=-19;"timeAtom";
    code=-18;"secondAtom";
    code=-17;"minuteAtom";
...
/ --------------------------------------------------
.test.nsj.exists:{[fnSym]
  fnVal:.test.nsj.resolve fnSym;
  not fnVal~(::)
 };
...
/ --------------------------------------------------
.test.nsj.capture:{[label;fnSym]
  fnExists:.test.nsj.exists fnSym;
  fnVal:.test.nsj.resolve fnSym;
  ...
  resultTypeName:$[ok;.test.nsj.typeLabel resultTypeCode;""];
  resultPreview:$[ok;.test.nsj.preview resultVal;""];
