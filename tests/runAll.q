...
/ --------------------------------------------------
.testAll.runners:([]
  topic: `keywords`joins`iterators`overloads`dataTypes`tables`args`namespaceJ`namespaceQ`namespaceZ`internals`analyze`sim`consistency;
  script:("tests/runKeywords.q";"tests/runJoins.q";"tests/runIterators.q";"tests/runOverloads.q";"tests/runDataTypes.q";"tests/runTables.q";"tests/runArgs.q";"tests/runNamespaceJ.q";"tests/runNamespaceQ.q";"tests/runNamespaceZ.q";"tests/runInternals.q";"tests/runAnalyze.q";"tests/runSim.q";"tests/runConsistency.q")
 );
