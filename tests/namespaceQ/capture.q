/ ==================================================
/ namespaceQ example capture functions
/ ==================================================

/ --------------------------------------------------
/ map q type code to readable label
/ --------------------------------------------------
.test.nsq.typeLabel:{[typeCode]
  code:`int$typeCode;
  $[code=-19;"timeAtom";
    code=-18;"secondAtom";
    code=-17;"minuteAtom";
...
/ --------------------------------------------------
.test.nsq.exists:{[fnSym]
  fnVal:.test.nsq.resolve fnSym;
  not fnVal~(::)
 };
...
/ --------------------------------------------------
.test.nsq.capture:{[label;fnSym]
  fnExists:.test.nsq.exists fnSym;
  fnVal:.test.nsq.resolve fnSym;
  ...
  resultTypeName:$[ok;.test.nsq.typeLabel resultTypeCode;""];
  resultPreview:$[ok;.test.nsq.preview resultVal;""];
